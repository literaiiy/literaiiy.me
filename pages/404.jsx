export default function Custom404() {
  return (
    <div class="error">
      <title>404 - literaiiy.me</title>
      <h1>404</h1>
      <p>Oops! This page doesn't seem to exist. Try again with a different URL or go <a href="/" style={{textDecoration: "underline",}}>back</a>.</p>
